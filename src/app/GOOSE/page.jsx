			...
			<div className='lg:flex'>
				<motion.div
					...
					<div className='flex flex-col items-center gap-[1rem] text-center lg:text-left lg:items-start lg:ml-[5rem]'>
						...
						<h1 className="text-[2rem] mt-[1rem] font-bold mx-[1rem] tracking-[1px] text-[#4a5e2a] lg:mt-0 lg:text-[3rem] xl:text-[5rem] lg:mx-0">GOOSE</h1>
						<h2 className="text-[20px] font-bold mt-[-15px] tracking-[1px] text-[#627b3b] lg:text-[2.2rem]">Sep 2023</h2>
						...
						<div>
							<div className="flex gap-[1rem] mt-[0.8rem] lg:mt-[1.5rem]">
								<a target="_blank" href="https://sillygoose.vercel.app">
									<div className="w-[2.5rem] lg:w-[45px] xl:w-[60px] hover:scale-[105%] transition-all duration-500">
