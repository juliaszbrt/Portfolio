			...
			<div className='lg:flex'>
				<div className="lg:fixed lg:w-1/2 lg:mt-[3rem]">
					<div className='flex flex-col items-center gap-[1rem] text-center lg:text-left lg:items-start lg:ml-[5rem]'>
						...
						<h1 className="text-[25px] font-bold mx-[1rem] tracking-[1px] text-[#42571f] md:text-[35px] lg:text-[45px] lg:mx-0">Comp Sci. Course Union</h1>
						<h2 className="text-[20px] font-bold mt-[-15px] tracking-[1px] text-[#627b3b] md:text-[25px] lg:text-[35px]">CSCU</h2>
						...
						<motion.div
							...
							<div className="flex gap-[1.5rem] mt-[0.8rem] lg:mt-[1.5rem]">
								<a target="_blank" href="https://www.instagram.com/tmu_cscu/">
								...
								<a target="_blank" href="https://tmucscu.com/">
									<div className="w-[30px] lg:w-[47px] hover:scale-[105%] transition-all duration-500">
							...
							<div className='mt-[2rem] md:mt-[3rem] flex flex-col justify-center gap-[2rem]'>
								<div>
									<div className='w-[20rem] border-[3px] border-[#708450] hover:scale-[105%] transition-all duration-500 md:w-[32rem]'>
										<Image src="/community/boardGame.jpg" width={5330} height={3553}></Image>
									</div>
                                </div>
                                <div>
									<div className='w-[20rem] border-[3px] border-[#708450] hover:scale-[105%] transition-all duration-500 md:w-[32rem]'>
										<Image src="/community/cscu.jpg" width={5330} height={3553}></Image>
									</div>
								</div>
							</div>
						</motion.div>
