        ...
        <div className="flex justify-center">
          <div className="flex flex-col">
            ...
            <div className="flex items-center flex-col gap-[4rem] md:gap-[2rem] lg:flex-row lg:justify-start mt-[3rem]">
              ...
              <div id="cohereBox2" className="flex items-center w-[17rem] h-[17rem] p-[30px] md:w-[17rem] md:h-[17rem] lg:w-[18rem] lg:h-[18rem] xl:w-[22rem] xl:h-[22rem] border-[3px] border-[#3C1D06] border-dashed">
                <div id="cohere">
