...
const Experience = () => {
  return (
    <div>
      <div className="bg-[#fff8f3] h-auto px-[5rem] py-[5rem] [font-family:var(--font-murecho)]">
        <div className="flex justify-center">
          <div className="flex flex-col">
            <motion.div
              ...
              <h1 className="text-center text-[30px] md:text-[3rem] xl:text-[4rem] tracking-[10px] lg:tracking-[8px] text-[#3C1D06] font-bold [font-family:var(--font-domine)]">Experience</h1>
            </motion.div>
