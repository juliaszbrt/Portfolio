			...
			<div className="h-screen flex flex-col justify-center items-center lg:flex-row lg:px-[8rem] py-0 lg:py-[2rem]">
				...
				<div className="lg:w-2/3 flex items-center justify-center">
					<motion.div
						...
						<h1 className="text-[#bdc6af] text-center text-[1.2rem] md:text-[2.5rem] lg:text-[1.5rem] xl:text-[2rem] tracking-[4px] leading-[2rem] md:leading-[4rem] lg:leading-[3rem] xl:leading-[4rem] font-bold [font-family:var(--font-murecho)] mx-[1.5rem]"><em>is a Developer, Designer, and Creator at Toronto MetU</em></h1>
						<div className="hidden justify-center items-center mt-[1rem] xl:mt-[3rem] lg:flex gap-[3rem] xl:gap-[5rem]">
							<a href='#portfolio' className='text-[#f8c137] font-normal hover:scale-[110%] transition-all duration-500 [font-family:var(--font-murecho)]'>
								<CircularText
									text="PORTFOLIO&#x2605;"
									xlFontSize="18px"
									xlHeight="130px"
							...
							<a href='#about' className='text-[#f8c137] font-normal tracking-[0px] hover:scale-[110%] transition-all duration-500 [font-family:var(--font-murecho)]'>
								<CircularText
									text="BIOGRAPHY&#x2605;"
									xlFontSize="18px"
									xlHeight="130px"
							...
							<a href='#experience' className='text-[#f8c137] font-normal tracking-[0px] hover:scale-[110%] transition-all duration-500 [font-family:var(--font-murecho)]'>
								<CircularText
									text="EXPERIENCE&#x2605;"
									xlFontSize="18px"
									xlHeight="130px"
