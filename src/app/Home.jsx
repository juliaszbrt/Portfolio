				...
				<div className="lg:w-2/3 flex items-center justify-center">
					<motion.div
						...
						<div className="hidden justify-center items-center mt-[1rem] xl:mt-[3rem] lg:flex gap-[3rem] xl:gap-[5rem]">
							...
							<a href='#about' className='text-[#f8c137] font-medium tracking-[0px] hover:scale-[110%] transition-all duration-500 [font-family:var(--font-murecho)]'>
								<CircularText
									text="BIOGRAPHY&#x2605;"
									xlFontSize="18px"
									xlHeight="130px"
							...
							<a href='#experience' className='text-[#f8c137] font-medium tracking-[0px] hover:scale-[110%] transition-all duration-500 [font-family:var(--font-murecho)]'>
								<CircularText
									text="EXPERIENCE&#x2605;"
									xlFontSize="18px"
									xlHeight="130px"
