			...
			<div className='lg:flex'>
				<motion.div
					...
					<div className='flex flex-col items-center gap-[1rem] text-center lg:text-left lg:items-start lg:ml-[5rem]'>
						...
						<h1 className="text-[2rem] mt-[1rem] font-bold mx-[1rem] tracking-[1px] text-[#4a5e2a] lg:mt-0 lg:text-[3rem] xl:text-[5rem] lg:mx-0">Algorithm Visualizer</h1>
						<h2 className="text-[20px] font-bold mt-[-15px] tracking-[1px] text-[#627b3b] lg:text-[2.2rem]">Coming soon...</h2>
						<p className="text-left text-[13px] mx-[2rem] tracking-[1px] text-[#708450] lg:ml-0 lg:mt-[1rem]"></p>
						{/* <ul className="text-[13px] mx-[2rem] tracking-[1px] text-[#708450] md:text-[20px] lg:ml-0 lg:mt-[1rem]">
						...
						{/* <div>
							<div className="mt-[0.8rem] lg:mt-[1.5rem]">
								<a target="_blank" href="https://www.figma.com/design/LDm4mqqWuGKnF59fiYZcT2/Personal-Website--Update-?node-id=0-1&t=n7YLKhWHWrNfcilf-1">
									<div className="w-[30px] ml-[-13px] lg:w-[60px] hover:scale-[105%] transition-all duration-500">
