			...
			<div className='lg:flex'>
				<div className="lg:fixed lg:w-1/2 lg:mt-[3rem]">
					<div className='pt-[3rem] flex flex-col items-center gap-[1rem] text-center lg:text-left lg:items-start lg:ml-[5rem]'>
						...
						<p className="text-[13px] mx-[2rem] tracking-[1px] text-[#c4a558] md:text-[15px] lg:text-[20px] lg:ml-0 lg:mt-[1rem]">Refined the art of packing information into a design without overwhelming the viewer.
							<br />
							<br /> 
							These graphics showcase my ability to capture and hold attention by thoughtfully balancing colours, elements, and text, creating a compelling final product.</p>
						<motion.div
							initial={{ opacity: 0 }}
