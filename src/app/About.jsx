          ...
          {isClient ? (
            ...
            >
              <div className="relative h-[16rem] w-[16rem] lg:h-[18rem] lg:w-[18rem] 2xl:h-[20rem] 2xl:w-[20rem] rounded-full border-[1.5rem] border-[#FFDDC2] overflow-hidden">
                <Image alt="profile photo" loading="lazy" width={1242} height={1242} src="/headshot.png" className="object-cover rounded-full"></Image>
              </div>
            ...
            <div className="flex items-center flex-col pt-[2rem] mb-[2rem] lg:my-0 lg:pl-[1rem]">
              <div className="relative h-[16rem] w-[16rem] lg:h-[18rem] lg:w-[18rem] 2xl:h-[20rem] 2xl:w-[20rem] rounded-full border-[1.5rem] border-[#FFDDC2] overflow-hidden">
                <Image alt="profile photo" loading="lazy" width={1242} height={1242} src="/headshot.png" className="object-cover rounded-full"></Image>
              </div>
              <div className="py-[2rem] text-[0.8rem] text-center tracking-[1.8px] leading-6 text-[#c17942] lg:text-[1rem] lg:leading-8 lg:pb-0 2xl:text-[1.3rem] 2xl:leading-10">
