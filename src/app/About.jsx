        ...
        <div className="flex flex-col gap-[3rem] lg:flex lg:flex-row lg:justify-center">
            <div className="lg:flex gap-[4rem] lg:my-[4rem] lg:items-center lg:basis-4/5 lg:justify-center">
                <div className="flex justify-center mt-[4rem] mb-[2rem] lg:my-0">
                    <Image width={1242} height={1242} src="/headshot.jpg" className="rounded-full h-[16rem] w-[16rem] border-[1rem] border-[#FFDDC2] lg:h-[18rem] lg:w-[18rem]"></Image>
                </div>
                <div className="flex justify-center ">
                    <div className="w-[16rem] lg:w-[25rem]">
                        <h1 className="mb-[1rem] text-[1.7rem] tracking-[5px] font-semibold text-[#3C1D06] lg:text-[2rem]">ABOUT ME...</h1>
                        <p className="text-justify text-[0.8rem] tracking-[1.8px] leading-relaxed text-[#3C1D06] lg:text-[1rem]">
                            ...
                            constantly putting myself up for new 
                            challenges. 
                        </p>
                    </div>
                </div>
            </div>
            <div className="relative h-[10rem] lg:h-[35rem] lg:basis-1/5">
